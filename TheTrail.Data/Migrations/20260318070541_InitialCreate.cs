        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArtworkUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Collectibles_Chapters_ChapterId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserId = table.Column<string>(type: "text", nullable: false),
                    ChapterId = table.Column<int>(type: "integer", nullable: false),
                    ScrollCompleted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    QuizPassed = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserChapterProgresses", x => new { x.UserId, x.ChapterId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Badges_EraId",
                table: "Badges",
                column: "EraId");

            migrationBuilder.CreateIndex(
                name: "IX_Chapters_EraId",
                table: "Chapters",
                column: "EraId");
