...
namespace TheTrail.Data.Seeding
{
    public static class DataSeeder
    {
            ...
            RoleManager<IdentityRole> roleManager)
        {
            ...
            await SeedCollectiblesAsync(context);
        }

        private static async Task SeedCollectiblesAsync(TheTrailDbContext context)
        {
            if (!await context.Collectibles.AnyAsync())
            {
                ...
                context.Collectibles.Add(new Domain.Entities.Collectible
                {
                    Name = "T-Rex",
                    Description = "The apex predator of the prehistoric era. Earned by those who walked the trail and proved their knowledge.",
                    ArtworkUrl = "/images/collectibles/trex.jpg",
                    Rarity = Domain.Enums.Rarity.Common,
                    ChapterId = chapterId,
                });
    ...
    new { type = "image", url = "/images/chapters/landscape.png", caption = "The prehistoric Earth — a world of ancient ferns, towering conifers and vast untamed wilderness." },
    ...
    new { type = "image", url = "/images/chapters/meteor.png", caption = "The Chicxulub impact — the moment that ended 165 million years of dinosaur dominance." },
    ...
    new { type = "image", url = "/images/chapters/birds.png", caption = "Modern birds — the living descendants of the dinosaurs, carrying their legacy into the present day." }
                });
